...
using SchoolManage.Sessions;
using SchoolManage.Web.Models.Account;
using SchoolManage.Web.Views.Shared.Components.TenantChange;

namespace SchoolManage.Web.Controllers
{
    public class AccountController : SchoolManageControllerBase
    {
