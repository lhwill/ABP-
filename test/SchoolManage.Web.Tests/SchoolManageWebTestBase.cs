...
{
    public abstract class SchoolManageWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SchoolManageWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SchoolManageWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SchoolManageDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SchoolManageDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SchoolManageDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SchoolManageDbContext, Task<T>> func)
        {
            T result;
